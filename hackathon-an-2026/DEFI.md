...
LoiHub ne se contente pas de montrer “ce que dit la loi”, mais explique :

    `comment et pourquoi elle est devenue ce qu’elle est aujourd’hui`

Cela transforme un processus opaque en un système lisible, comparable à un historique de développement logiciel.


#### 🚀 Impact
- Meilleure compréhension des lois par les citoyens
- Transparence du travail parlementaire
- Valorisation du travail des députés et des amendements
- Outil pédagogique pour comprendre la démocratie législative
